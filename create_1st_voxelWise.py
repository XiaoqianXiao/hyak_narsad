...
CONTAINER_PATH = "/gscratch/scrubbed/fanglab/xiaoqian/repo/hyak_narsad/narsad-fmri_1st_level_1.0.sif"
...
def get_condition_names_from_events(events_file):
    ...
    Returns:
        tuple: (contrasts, condition_names, df_with_conditions)
    """
    ...
    interesting_contrasts = [
        ("CS- > FIXATION", "Other CS- trials vs baseline"),
        ("CSS > FIXATION", "Other CSS trials vs baseline"),
        ("CSR > FIXATION", "Other CSR trials vs baseline"),
        ("CSS > CSR", "Other CSS trials vs Other CSR trials"),
        ("CSR > CSS", "Other CSR trials vs Other CSS trials"),
        ("CSS > CS-", "Other CSS trials vs Other CS- trials"),
        ("CSR > CS-", "Other CSR trials vs Other CS- trials"),
        ("CS- > CSS", "Other CS- trials vs Other CSS trials"),
        ("CS- > CSR", "Other CS- trials vs Other CSR trials"),
    ]
...
apptainer exec \\
    ...
    -B /gscratch/scrubbed/fanglab/xiaoqian/repo/hyak_narsad:/app \\
    {container_path} \\
