...
def extract_cs_conditions(df_trial_info):
    """
    Extract and group CS- conditions from a pandas DataFrame.
    
    This function adds a 'conditions' column to the DataFrame that groups trials:
    - First trial of CS- type becomes 'CS-_first'
    - Remaining trials of CS- become 'CS-_others'
